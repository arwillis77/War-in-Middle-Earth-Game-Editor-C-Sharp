...
namespace War_in_Middle_Earth_Game_Editor_C_Sharp
{
    public partial class frmWIMEEditorMain : Form
    {
        ...
        {
            LoadedResourceList = new ResourceList();
            LoadedResourceList = ResourceList.InitializeResourceList(currentFormat.Name);           /* Intializes list of all resources for the file format */
            ...
            for (int x = 0; x < ResourceFile.chunkID.Length; x++)
            {
                ...
                frmResourceList p_form = new frmResourceList(ResourceFile.chunkTypes[x], LoadedResourceList);
